...
void main() {
  test('interaction classes cover phones, tablet rotations and desktop windows',
      () {
    expect(KoDeviceLayout.forSize(const Size(320, 568)).kind,
        KoDeviceKind.smallPhone);
    expect(KoDeviceLayout.forSize(const Size(360, 800)).kind,
        KoDeviceKind.smallPhone);
    expect(KoDeviceLayout.forSize(const Size(430, 932)).kind,
