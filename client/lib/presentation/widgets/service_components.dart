...
class _ServiceWorkspaceState extends State<ServiceWorkspace> {
  ...
  Widget build(BuildContext context) => LayoutBuilder(builder: (context, c) {
        ...
        final secondary =
            KeyedSubtree(key: _secondaryKey, child: widget.secondary);
...
String servicePercent(
    BuildContext context, Object? numerator, Object? denominator) {
  ...
  Widget build(BuildContext context) {
    ...
    return KoPanel(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(error ? l10n.genericError : l10n.loadingLabel,
              style: koDisplayStyle(size: 25), textAlign: TextAlign.center),
          if (onRetry != null) ...[
...
class ServiceGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      LayoutBuilder(builder: (context, constraints) {
        final columns =
            (constraints.maxWidth / (minWidth + 18)).floor().clamp(1, 4);
                        ...
                        child: Column(
                            ...
                            children: [
                              KoHeading(
                                  ...
                                  trailing: const DoodleIcon(Doodle.hailer,
                                      size: 40)),
                              TextFormField(
