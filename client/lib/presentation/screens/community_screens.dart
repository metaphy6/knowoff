...
class _ContributorConnectScreenState extends State<ContributorConnectScreen> {
  ...
  Future<void> _open() async {
    ...
    try {
      final opened =
          await (widget.openBrowser?.call(_api.portalLoginUri) ??
              launchUrl(
                _api.portalLoginUri,
    ...
    return KoPage(
      ...
      child: _loadForbidden
          ...
          ? KoPanel(
              ...
              child: Text(l.challengeEmpty, style: koDisplayStyle(size: 28)),
            )
          : Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                Text(l.challengeIntro, style: koDisplayStyle(size: 36)),
                const SizedBox(height: 12),
                ...
                if (_loadFailed || _actionError != null) ...[
                  ...
                  Semantics(
                    ...
                    child: KoPanel(
                      color: KoColors.pink,
                      child: Text(_actionError ?? l.challengeRefreshFailed),
                    ),
                  ),
                ],
