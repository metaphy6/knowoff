...
class _KnowoffScreenState extends ConsumerState<KnowoffScreen> {
  ...
  static const int _ballotSeconds = 20;
  static const int _runoffSeconds = 15;
  static const int _resultSeconds = 15;
  ...
  int _windowFor(String phase) {
    switch (phase) {
      case 'runoff':
        return _runoffSeconds;
      case 'result':
        return _resultSeconds;
      default:
        return _ballotSeconds;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final window = _windowFor(dto.phase);
