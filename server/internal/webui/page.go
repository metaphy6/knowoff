...
var adminNav = []navItem{{"/admin/", "Overview"}, {"/admin/portal/applications", "Roles & applications"}, {"/admin/portal/submissions", "Submission review"}, {"/admin/portal/challenge", "Weekly challenge"}, {"/admin/leaderboard", "Weekly leaderboard"}, {"/admin/portal/terms", "Contribution terms"}, {"/admin/text", "Text releases"}, {"/admin/user-terms", "User terms"}, {"/admin/notices", "System notices"}, {"/admin/reports", "Reports"}, {"/admin/feedback", "Feedback"}, {"/admin/economy", "Accounts & economy"}, {"/admin/operators", "Operator actions"}}
