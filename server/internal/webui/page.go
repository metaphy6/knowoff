...
var adminNav = []navItem{{"/admin/", "Overview"}, {"/admin/portal/applications", "Roles & applications"}, {"/admin/portal/submissions", "Submission review"}, {"/admin/portal/challenge", "Weekly challenge"}, {"/admin/portal/terms", "Contribution terms"}, {"/admin/notices", "System notices"}, {"/admin/reports", "Reports"}, {"/admin/feedback", "Feedback"}, {"/admin/economy", "Accounts & economy"}}
