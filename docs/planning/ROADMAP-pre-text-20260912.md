> **Historical snapshot — superseded 2026-09-12.** Preserve prior checkboxes and
> evidence as recorded; they do not authorize further image/specialty/backfill
> work and do not prove text-transition readiness. Use [the active Roadmap](ROADMAP.md).
> Several old sequence/reconnect/backup/settlement claims lack current source
> proof; the active Roadmap explicitly reopens them.
