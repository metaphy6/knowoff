...
blueprint chapters; do not invent or assume missing sections.

## Loop (per bullet)

1. **Read** the bullet in the context of the phase's required blueprint
   chapters, What/Why/How, and Proof tests.
...
2. **Verifier** — delegate to the [`verifier`](verifier.agent.md) (subagent or
   ...
   it runs the server and client test and lint gates cold with the invariant checks, returning PASS / FAIL.
