...
| **Testing** | `make test` / `make verify`, the test-runner tool, [`flaky-test-triage`](../../.agents/skills/flaky-test-triage/SKILL.md) — tests always move with the code that needs them (AGENTS.md §3). |
